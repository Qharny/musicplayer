...
class FavoriteScreen extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${audioManager.songs.length} favorite tracks and 8 playlists.',
                          style: TextStyle(
                  ...
                  if (audioManager.songs.isEmpty)
                    ...
                    ...List.generate(
                      audioManager.songs.length > 3 ? 3 : audioManager.songs.length,
                      (index) {
  ...
  Widget _buildTrackItem(String title, String subtitle, int songId, int actualIndex, AudioManager audioManager) {
    return InkWell(
